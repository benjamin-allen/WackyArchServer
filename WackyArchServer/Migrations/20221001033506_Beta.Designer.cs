...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WackyArchServer.Model.BetaChallenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("InputProgramJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("BetaChallenges");
                });

            modelBuilder.Entity("WackyArchServer.Model.CompletedAlphaChallenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WackyArchServer.Model.CompletedBetaChallenge", b =>
                {
                    ...
                    b.Property<Guid>("BetaChallengeId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("BetaChallengeId");

                    b.ToTable("CompletedBetaChallenges");
                });
            ...
            modelBuilder.Entity("WackyArchServer.Model.BetaChallenge", b =>
                {
                    b.HasOne("WackyArchServer.Model.BetaChallenge", "Predecessor")
                        .WithMany()
                        .HasForeignKey("PredecessorId");
            ...
            modelBuilder.Entity("WackyArchServer.Model.CompletedBetaChallenge", b =>
                {
                    b.HasOne("WackyArchServer.Model.BetaChallenge", "BetaChallenge")
                        .WithMany()
                        .HasForeignKey("BetaChallengeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BetaChallenge");
                });
